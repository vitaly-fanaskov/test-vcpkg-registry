...
message(STATUS "Copy ${CMAKE_CURRENT_LIST_DIR}/CMakeLists.txt -> ${SOURCE_PATH}")

file(COPY ${CMAKE_CURRENT_LIST_DIR}/botanConfig.cmake.in DESTINATION ${SOURCE_PATH}/cmake)
message(STATUS "Copy ${CMAKE_CURRENT_LIST_DIR}/botanConfig.cmake.in -> ${SOURCE_PATH}/cmake")

message(STATUS "Call vcpkg_cmake_configure")
vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}
    PREFER_NINJA
)
vcpkg_install_cmake()
message(STATUS "Call vcpkg_cmake_config_fixup")
vcpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/")

#file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/debug)

#configure_file(
#    ${CMAKE_CURRENT_LIST_DIR}/botan-config.cmake.in
#    ${CURRENT_PACKAGES_DIR}/share/botan-configure/botan-configure.cmake
#    @ONLY
#)
